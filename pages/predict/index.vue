    ...
    <v-layout row wrap>
        <v-flex xs12 sm8 offset-sm2>
            <v-card class="mt-5" style="border-radius: 15px">
                ...
                <v-divider></v-divider>
                <v-card-text>
                    <div>Browse some image on your device that you want to classify and you will get the top 3 predictions the model made.</div>
                    <hr class="mt-3 mb-3">
                    <v-layout row>
                        <!-- <v-flex xs6 d-flex>
              <v-select
              ...
              ></v-select>
                    ...
                    <v-layout class="mt-3" row wrap v-if="predictions.hasPrediction">
                        <v-flex xs12>
                            ...
                            <p
                                v-for="(pred, index) in predictions.top3"
                                :key="index"
                            >{{ pred.className }} - {{ pred.probability.toFixed(2) + '%' }}</p>
                        </v-flex>
                    </v-layout>
                </v-card-text>
            </v-card>
